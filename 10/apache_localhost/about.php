...
$num1 = rand(1, 10); // Первое число
$num2 = rand(1, 10); // Второе число
$sum = $num1 + $num2; // Сумма чисел

// Сохранение суммы в сессии для проверки
...
?>
        ...
        <form method="POST" id="feedbackForm">
            ...
            <br />
            <!-- Капча --><label for="captcha">Сколько будет <?= $num1 ?> + <?= $num2 ?>?</label>
